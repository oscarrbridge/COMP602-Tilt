...
export default function Crash() {
 ...
 // ----- animation loop -----
  ...
  async function cashOut() {
    ...
    setHistory((h) => [
      { id: roundId, crashPoint: crashPoint ?? m, cashedOutAt: m, profitDisplay },
      ...h,
    ].slice(0, 15));
    queueNextRound();
  }
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      await refreshBalance();
      setHistory((h) => [
        { id: roundId, crashPoint: crashPoint ?? currentMult, profitDisplay: -bet },
        ...h,
      ].slice(0, 15));
      queueNextRound();
    })();
      ...
      <div style={{ width: "100%", maxWidth: 1100, margin: "0 auto", padding: 16 }}>
        ...
        <div className="crash-card">
          ...
          >
            ...
            <polyline fill="none" stroke="url(#crashLine)" strokeWidth={5.5} filter="url(#glow)" points={graph.poly} />
              ...
              <tbody>
                {history.map((h) => (
                  <tr key={h.id}>
                    ...
                    <td style={{ color: h.profitDisplay >= 0 ? "#10b981" : "#ef4444", fontWeight: 600 }}>
